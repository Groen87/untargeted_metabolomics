#!/usr/bin/env python3
"""
Main script to process multiple batches simultaneously.
...
Usage:
    python multi_batch_main.py --batches MZ25_36 MZ26_10 MZ27_15
    python multi_batch_main.py --batches MZ25_36 MZ26_10 --mode NEG
"""
...
from metabolomics_pipeline.pipeline.multi_batch_combat import (
    find_pqn_files,
...
def main():
    ...
    parser.add_argument(
        "--config",
        default=None,
        help="Path to config file (default: metabolomics_pipeline/config/config.yaml)",
    )
