...
def merge_batches_for_combat(
    ...
    # Note: df1_renamed/df2_renamed have Compounds ID (or Feature) as index
    # We need to get Feature and RT from the rt dataframes
    metadata_df1 = rt1[['Feature', 'RT [min]']].drop_duplicates()
    metadata_df2 = rt2[['Feature', 'RT [min]']].drop_duplicates()
